        ...
        <div className="Sender">
            <div className="messageSender">
                <div className="messageHeader">
                    <div className="messageHeaderAvatar" style={{ backgroundImage: `url(${sidebarData[Math.floor(match?.params.userId)]?.image})` }} onClick={profileSenderHand}>
                    ...
                    <div className="messageHeaderInfo" onClick={profileSenderHand}>
                        ...
                        <p className="chatMemberInfo" style={{color:'blue'}}>online</p>
                    </div>
            ...
            <div className="profileSidebar">
                ...
                <div className="profileSidebar_body" >
                    <img src={sidebarData[Math.floor(match?.params.userId)]?.image} className={'sidebar_profileInfo'} alt="images" />
                </div>
            </div>
        </div>
    )
